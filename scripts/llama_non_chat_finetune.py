...
def format_chat_template(row):
    ...
    # row["text"] = tokeniser_chat.apply_chat_template(row_json, tokenize=False)
    row["full"] = row["prompt"] + " " + row["completion"]
    return row
...
training_args = TrainingArguments(
    output_dir='experiments/polarity/' + f'/Poisoned_{project_name}_no_template'  ,       # output directory
